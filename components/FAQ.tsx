  ...
  return (
    <section className="py-24" id="faq">
      <div className="max-w-[900px] mx-auto px-8">
        ...
        <div className="mt-12">
          <div className="neu-elevated rounded-xl p-8 text-center border-l-4 border-accent-gold">
            <div className="mb-4">
              <svg className="w-12 h-12 mx-auto text-accent-gold mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <h3 className="font-heading text-xl font-bold text-dev-hub-text-primary mb-2">
                ¿No encontraste tu respuesta aquí?
              </h3>
              <p className="text-dev-hub-text-secondary">
                Estamos disponibles para resolver cualquier duda que tengas sobre nuestros servicios.
              </p>
            </div>
            <a
