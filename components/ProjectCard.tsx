...
export default function ProjectCard({
  ...
  return (
    <div className="group rounded-xl overflow-hidden neu-elevated transition-all duration-500 hover:scale-[1.02]">
      ...
      <div className="p-6">
        <h3 className="font-heading text-xl font-bold mb-3 group-hover:text-accent-gold transition-colors">
          {title}
        </h3>
        <p className="text-dev-hub-text-secondary text-sm mb-4 line-clamp-2">
          {description}
        </p>
        ...
        <div className="flex gap-3">
          {liveUrl && (
            <button className="flex-1 bg-accent-gold text-white py-2 px-4 rounded-lg text-sm font-semibold transition-all duration-300 hover:bg-accent-gold-hover active:scale-95 shadow-md">
              Ver Proyecto
            </button>
          )}
          {repoUrl && (
            <button className="flex-1 bg-transparent border-2 border-dev-hub-border text-dev-hub-text-primary py-2 px-4 rounded-lg text-sm font-semibold transition-all duration-300 hover:border-accent-gold hover:text-accent-gold active:scale-95">
              Ver Código
            </button>
          )}
        </div>
