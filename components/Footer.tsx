        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            <a 
              ...
              className="text-dev-hub-text-secondary hover:text-accent-gold transition-colors duration-300"
              aria-label="GitHub"
            >
            ...
            <a 
              href="https://www.linkedin.com/in/elsantin" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-dev-hub-text-secondary hover:text-accent-gold transition-colors duration-300"
              aria-label="LinkedIn"
