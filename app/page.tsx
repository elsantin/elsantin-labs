            ...
            <div className="text-center">
              ...
              <div className="flex gap-4 justify-center flex-wrap">
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-[var(--color-accent-gold)] text-[var(--color-text-on-gold)] py-4 px-8 rounded-lg font-medium transition-all duration-300 hover:bg-[var(--color-accent-gold-hover)] hover:shadow-[0_8px_20px_rgba(163,126,79,0.3)] hover:-translate-y-1"
                  target="_blank"
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-[var(--color-dev-hub-surface)] text-[var(--color-dev-hub-text-primary)] py-4 px-8 rounded-lg font-medium border border-[var(--color-dev-hub-border)] transition-all duration-300 hover:border-[var(--color-accent-gold)] hover:text-[var(--color-accent-gold)] hover:-translate-y-1"
                >
